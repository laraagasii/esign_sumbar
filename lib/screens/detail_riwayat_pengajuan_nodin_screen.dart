...
class DetailRiwayatPengajuanNodinScreen extends StatefulWidget {
  ...
  State<DetailRiwayatPengajuanNodinScreen> createState() =>
      _DetailRiwayatPengajuanNodinScreenState();
}

class _DetailRiwayatPengajuanNodinScreenState
    extends State<DetailRiwayatPengajuanNodinScreen> {
  ...
  List<Map<String, dynamic>> _mapRiwayatPemeriksaan(dynamic riwayatData) {
    ...
    return riwayatData.map<Map<String, dynamic>>((item) {
      ...
      if (status.toUpperCase() == 'DISETUJUI' ||
        ...
        status = 'Ditolak';
      } else if (status.toUpperCase() == 'BELUM DIPERIKSA') {
                          ...
                          _buildSectionCard(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildInfoRow(
                                  "Tanggal Pelaksanaan",
                                  detailInfo['tanggal_pelaksanaan'] ?? '-',
                                ),
  ...
  Widget _buildMemberCard(String name, String badge, String role) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isBatal ? const Color(0xFFFFEBEE) : const Color(0xFFFFFBEB),
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: isBatal ? const Color(0xFFE53935) : const Color(0xFFD4A72C),
            size: 24,
          ),
