...
class FilterSPTDialog extends StatefulWidget {
  final Map<String, dynamic>? currentFilters;

  const FilterSPTDialog({super.key, this.currentFilters});

  @override
  State<FilterSPTDialog> createState() => _FilterSPTDialogState();
}
